...
<body>
    <div class="container">
        <div class="property-header">
            <img src="image_house/livingroom_1.jpg" alt="Ruang Tamu" onclick="openModal(this)"> <!-- Tukar path Gambar -->
            <img src="image_house/Makeuproom_1.jpg" alt="Bilik tidur" onclick="openModal(this)"> <!-- Tukar path Gambar -->
            <img src="image_house/bathroom_1.jpg" alt="Tandas" onclick="openModal(this)"> <!-- Tukar path Gambar -->
        </div>
    ...
    <script>
        ...
        <div class="property-details">
            <?php include 'index_rumah_1.php'?> <!-- Ubah index_rumah ikut nombor rumah -->
            <div class="details-grid"> 
                <!-- Nak ubah atau nak tambah information tentang rumah sewa-->
                <div><span>Tel No:</span> <span>017-4897946</span></div>
                <div><span>Floor Location:</span> <span>1 tingkat</span></div>
                <div><span>Perabot:</span> <span>Sofa, Meja, katil</span></div>
